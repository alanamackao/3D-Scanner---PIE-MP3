...
degreeChange = int(
    servoRange / graphDimensions
)  # number of degrees to iterate by each time servos move
...
xArray = (
    blankArray  # these 3 arrays will be used to graph the scan in cartesian coordinates
)
yArray = blankArray
zArray = blankArray
